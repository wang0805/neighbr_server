...
exports.getLeasesByProperty = exports.createProperty = exports.getProperty = exports.getProperties = void 0;
...
const getProperties = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (favoriteIds) {
            ...
            //sql query; use IN to check if p.id is in this favoriteIdsArray
            client_1.Prisma.sql `p.id IN (${client_1.Prisma.join(favoriteIdsArray)})`);
            if (priceMin) {
            ...
            if (amenities && amenities !== "any") {
                ...
                // @ represents check if the amenities is inside the array
            ...
            if (latitude && longitude) {
                ...
                const radiusInKilometers = 1000; //1km
                const degrees = radiusInKilometers / 111; // Converts kilometers to degrees
                // change this geometry to geography later on, so no need to use degrees
...
const createProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // have to convert the location they filled to coordinates using nominatim
        ...
        const geocodingResponse = yield axios_1.default.get(geocodingUrl, {
            headers: {
                "User-Agent": "Neighbr (testing@testing.com)",
            },
        });
        const [longitude, latitude] = ((_a = geocodingResponse.data[0]) === null || _a === void 0 ? void 0 : _a.lon) && ((_b = geocodingResponse.data[0]) === null || _b === void 0 ? void 0 : _b.lat)
            ...
            : [0, 0];
        // create location using raw query because coordinates is unsupported by prisma
      ...
      `;
        ...
        const newProperty = yield prisma.property.create({
            data: Object.assign(Object.assign({}, propertyData), { photoUrls, locationId: location.id, //location from @prisma client because typescript does not know shape of location without this. {location} is a typescript interface generated by Prisma
                managerCognitoId, amenities: typeof propertyData.amenities === "string"
...
const getLeasesByProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getLeasesByProperty = getLeasesByProperty;
